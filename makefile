...
ASMSRCDIR  = $(ASMNAME)
EMUSRCDIR  = $(EMUNAME)
ASMOBJS    = print.o dynarr.o $(ASMSRCDIR)/llist.o $(ASMSRCDIR)/str.o $(ASMSRCDIR)/err.o $(ASMSRCDIR)/parsed.o $(ASMSRCDIR)/parse.o $(ASMSRCDIR)/assemble.o $(ASMSRCDIR)/assemble_basic.o $(ASMSRCDIR)/assemble_full.o $(ASMSRCDIR)/cli.o
