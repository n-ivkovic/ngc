...
ASMSRCDIR  = $(ASMNAME)
EMUSRCDIR  = $(EMUNAME)
ASMOBJS    = print.o $(ASMSRCDIR)/llist.o $(ASMSRCDIR)/str.o $(ASMSRCDIR)/err.o $(ASMSRCDIR)/parsed.o $(ASMSRCDIR)/parse.o $(ASMSRCDIR)/assemble.o $(ASMSRCDIR)/assemble_common.o $(ASMSRCDIR)/assemble_basic.o $(ASMSRCDIR)/assemble_scoped.o $(ASMSRCDIR)/cli.o
